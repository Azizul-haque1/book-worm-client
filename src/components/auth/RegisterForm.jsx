...
export default function RegisterForm() {
    ...
    const onRegister = async (data) => {
        ...
        try {
            ...
            router.push('/login')
            // window.location.href = "/my-library"; // auto login redirect
                ...
                >
                    ...
                    <form onSubmit={handleSubmit(onRegister)} className="space-y-5">
                        <motion.div variants={itemVariants} className="space-y-4">
                            ...
                            <div className="form-control">
                                ...
                                <input
                                    type="file"
                                    accept="image/*"
                                    className={`file-input file-input-bordered w-full focus:file-input-secondary transition-all duration-200 bg-base-100 ${errors.photo ? 'file-input-error' : ''}`}
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            type="submit"
                            className={`btn btn-primary w-full shadow-lg hover:shadow-secondary/30 transition-all duration-300 ${isLoading ? 'loading' : ''}`}
                            disabled={isLoading}
                        >
